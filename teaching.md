...
- **Esteban Elías González Méndez** (2023).<br>
  ...
  Project: *Solving differential equations with neural networks*.<br>

- **Joshua Briones Andrade** (2022).<br>
  Undergraduate social service, ICF-UNAM.<br>
  Project: *Neural networks optimized by genetic algorithms in cosmology*.<br>
  Co-supervised with José Alberto Vázquez.<br>

- **Juan de Dios Rojas Olvera** (2021–2022).<br>
  Undergraduate social service, ICF-UNAM.<br>
  Project: *Observational cosmology with artificial neural networks*.<br>
  Co-supervised with José Alberto Vázquez.<br>
